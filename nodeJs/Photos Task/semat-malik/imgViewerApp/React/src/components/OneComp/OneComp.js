  ...
  <div className="header-right1" id="hd">
    ...
    <a >כינוס הכנסת בזמן הפוגה</a>
          ...
          <div className="relative">
           ...
           <p id="sub14"> <br/>תקנון תקנון  תקנון  תקנון  תקנון  תקנון  תקנון   תקנון  תקנון  
             תקנון תקנון  תקנון  תקנון  תקנון  תקנון  תקנון  תקנון  תקנון </p>
          ...
          <p><br/> היסטוריה היסטוריה היסטוריה היסטוריה היסטוריה היסטוריה   
          היסטוריה היסטוריה היסטוריה היסטוריה היסטוריה היסטוריה
          היסטוריה היסטוריה היסטוריה </p></div>
          </div>
          ...
          <p> <br/> עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד
          עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד עתיד </p>
             </div>
